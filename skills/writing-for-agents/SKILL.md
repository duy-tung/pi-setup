...
When the document you're writing is a skill, read [`SKILL-MECHANICS.md`](SKILL-MECHANICS.md) for frontmatter, invocation choice, and router skills (note: its frontmatter mechanics are Claude-Code-specific; pi supports only `name` and `description`).
