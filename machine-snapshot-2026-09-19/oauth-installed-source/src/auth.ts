...
// Fable 5.1 requires Claude Code >=2.1.251 on the OAuth inference route.
// Match the locally verified Claude Code release (2026-09-06).
const USER_AGENT = "claude-code/2.1.261";
